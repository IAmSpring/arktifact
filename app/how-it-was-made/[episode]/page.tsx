...
import { getEpisodeFiles, type EpisodeFile } from '@/data/episode-files/index';
...
export async function generateStaticParams() {
  // Generate paths for episodes 1-8
