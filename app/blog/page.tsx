...
import { blogPosts, getFeaturedPosts, getRegularPosts, getDefaultFeaturedPost } from '../../data/blog-posts';

const BlogPage = () => {
  const featuredPost = getFeaturedPosts()[0] || getDefaultFeaturedPost();
